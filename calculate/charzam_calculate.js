...
// include "infohub_base.js"
    ...
    const _GetPluginName = function($data ='') {
        ...
        return 'charzam_calculate_' + $pluginType;
    };
        ...
        if ($in.step === 'step_render_instructions') {
            return _SubCall({
                ...
                'data': {
                    ...
                    'where': {
                        'box_id': 'main.body.charzam_calculate.tools',
                        'max_width': 100,
    ...
    const click = function($in = {}) {
        ...
        if ($in.step === 'step_start') {
            ...
            return _SubCall({
                'to': {
                    'node': 'client',
                    'plugin': 'charzam_calculate_' + $childName,
    ...
    const call_server = function($in = {}) {
        ...
        if ($in.step === 'step_start') {
            if ($in.from_plugin.node === 'client') {
                if ($in.from_plugin.plugin.substring(0, 'charzam_calculate_'.length) === 'charzam_calculate_') {
    ...
    const get_available_options = function($in = {}) {
        ...
        if ($in.step === 'step_start') {
            return _SubCall({
                'to': {
                    'node': 'client',
                    'plugin': 'charzam_calculate_testcall',
...
//# sourceURL=charzam_calculate.js